                                ...
                                <li class="user-dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <c:if test="${user.role == 'ADMIN'}">
                                            ...
                                            <a href="${pageContext.request.contextPath}/admin/dashboard" style="color:#D4AF37;font-weight:700;"><i class="fas fa-tachometer-alt"></i> Quản trị Dashboard</a>
                                        </c:if>
                                        <div class="menu-divider"></div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <c:forEach items="${cars}" var="car">
                                    <div class="car-item">
                                        <img src="${not empty car.primaryImage ? pageContext.request.contextPath.concat('/').concat(car.primaryImage) : pageContext.request.contextPath.concat('/assets/images/default-car.jpg')}" alt="${car.modelName}" class="car-img">
                                        <div style="flex:1;">
